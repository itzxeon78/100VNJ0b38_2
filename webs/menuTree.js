...
function drawFolder()
{
  ...
  var addclass = "";
  if (leftSide.length == 18) addclass = " level1 " + this.desc;
  if (leftSide.length == 54) addclass = " level3";
  ...
  if (this.level > 0) {
    ...
    if ( this.hreference != "")
    docW = docW + "<a class='menuLink" + addclass + "' href='" + this.hreference + "' TARGET=\"basefrm\"" 
    else
    docW = docW + "<a class='menuLink" + addclass + "' TARGET=\"basefrm\"" 
	
    if (browserVersion > 0)
        docW = docW + "onClick='javascript:clickOnFolder("+this.id+")'"
	docW = docW + ">" + leftSide + "<span class='idot'>" + this.desc + "</span>" + "&nbsp;&nbsp;" + "</a>"         
    docW = docW + "</td>"
  }
...
function drawItem()
{
  ...
  docW = docW + "<tr>"
  docW = docW + "<td class='menuCell' valign=middle nowrap width=100%>"
  docW = docW + "<a class='menuLink" + addclass + "' href=" + this.link + ">" + leftSide + this.desc + "&nbsp;&nbsp;" + "</a>"
  docW = docW + "</td>"
  docW = docW + this.blockEndHTML()
  doc.write(docW)
